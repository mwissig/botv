...
class FlagsControllerTest < ActionDispatch::IntegrationTest
  ...
  test "should create flag" do
    assert_difference('Flag.count') do
      post flags_url, params: { flag: { flaggable_id: @flag.flaggable_id, flaggable_type: @flag.flaggable_type, message: @flag.message, reason: @flag.reason, user_id: @flag.user_id } }
    end
  ...
  test "should update flag" do
    patch flag_url(@flag), params: { flag: { flaggable_id: @flag.flaggable_id, flaggable_type: @flag.flaggable_type, message: @flag.message, reason: @flag.reason, user_id: @flag.user_id } }
