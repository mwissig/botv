...
class StatusesControllerTest < ActionDispatch::IntegrationTest
  ...
  test "should create status" do
    assert_difference('Status.count') do
      post statuses_url, params: { status: { brief: @status.brief, long: @status.long, rating: @status.rating } }
    end
  ...
  test "should update status" do
    patch status_url(@status), params: { status: { brief: @status.brief, long: @status.long, rating: @status.rating } }
